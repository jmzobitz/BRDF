...
#'
#' \code{old_gsvd_solution_compute} Computes residual and solution norm for a GSVD matrix decomposition
#'
...
old_gsvd_solution_compute<-function(gsvdResult,lambda_df,rho) {
